...
public class PubVar {
    ...
    public static GPSLocate m_GPSLocate;

    public static BaiduLocate m_BaiduLocate;

    public static GPSMap m_GPSMap=null;

    public static BaiDuMap m_BaiduMap=null;
    ...
    //网络是否连接
    public static boolean mIsNetworkAvaliable = true;
}
