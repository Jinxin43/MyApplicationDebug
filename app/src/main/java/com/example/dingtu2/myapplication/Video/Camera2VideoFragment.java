...
public class Camera2VideoFragment extends Fragment
    ...
    private static int minDuration = 100;    //最小录制时间
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        iv_finish.setOnClickListener(new NoDoubleClickListener() {
            ...
            protected void onNoDoubleClick(View view) {
                ...
                String ThumPath = bitmap2File(map, AppSetting.mPath.getAbsolutePath());
//                if (VideoControl._Callback != null) {
//                    VideoControl._Callback.OnClick("ok", ThumPath, mVideoPath);
//                }
...
//        }
    ...
    private String getVideoFilePath(Context context) {
        File path = new File(AppSetting.mPath, System.currentTimeMillis()+".mp4");
...
//权限end----------------------
    ...
    public void onDestroy() {
        super.onDestroy();
        File file=new File(AppSetting.mPath.getAbsolutePath());
        if(file.isDirectory()){
