...
public interface HttpInterface {
    ...
    @POST("/api/DTNotifications/{action}")
    Call<ResponseBody> BindDevice(@Path("action") String action, @Body BindModel dataDto);

    @POST("/api/DTNotifications/{action}")
    Call<ResponseBody> UnBindDevice(@Path("action") String action, @Body UnBindModel dataDto);

    @POST("/api/DTNotifications/{action}")
    Call<ResponseBody> AddBDLocation(@Path("action") String action, @Body BDBean bean);
