...
import com.DingTu.mapcontainer.TrackRectangle;
import com.baidu.tts.tools.SharedPreferencesUtils;
import com.example.dingtu2.myapplication.JPush.JPushUtil;
import com.example.dingtu2.myapplication.JPush.MyService;
        ...
        RoundActivity.mFinishCallbak = new ICallback() {
            ...
            public void OnClick(String Str, Object ExtraStr) {
                if (Str.equals("Finish")) {
                    AppSetting.curRound = null;
                    SharedPreferencesUtils.putBoolean(getApplicationContext(), "mIsRounding", false);
                    unloadTraces = true;
